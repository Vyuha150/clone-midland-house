        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl">
          <div className="mb-2">
            <img 
              ...
              className="h-96 md:h-[32rem] w-auto mx-auto mb-2 animate-fade-in drop-shadow-2xl"
            />
          </div>
          
          <p className="text-lg md:text-xl font-medium mb-3 animate-fade-in text-gray-100">
